...
namespace HeirRL.Source
{
    public class Image: Texture2D
    {
        ...
        static public Image FromStream(GraphicsDevice gDevice, FileStream File, string key)
        {
            ...
            var rectangles = Database.Textures.GetTextureRectangles(key);
            foreach (var rectangle in rectangles)
                newImage.Rectangles.Add(rectangle);
            
            //obsolete, used in older games with XML Atlas information provider
